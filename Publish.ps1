...
try {
    ...
    Write-Host "dotnet publish .\src\CMP.Api\ -c Release --os $platform -o $api_foldername -f 'net8.0'" -ForegroundColor Blue
    dotnet publish .\src\CMP.Api\ -c Release --os $platform -o $api_foldername -f 'net8.0'
